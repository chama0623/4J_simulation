...
int main(int argc,char *argv[]){
    ...
    return 0;
      ...
      \end{enumerate}
        ...
        $R=2\sqrt{\frac{L}{C}}$付近での動作を確認する. $L=10$,$C=0.3$という条件から$R=11.54$のときで
        ...
        あることが考えられる.このことは,式(\ref{qs})および式(\ref{is})の本質部分である$te^{-t}$の無限大の
        極限をとることで確認できる.式(\ref{rop})から式(\ref{ropzero})に$te^{-t}$の無限大の極限を計算した結果を示す.
