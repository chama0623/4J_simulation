...
0.03 & 7.314999 & 12.631163 & 7.314999 & 12.631163 \\ \hline
      ...
      \subsection{課題内容}
      ばね定数$k$のばねに質量$m$の物体がつながっているときの単振動のシミュレーションを行う.
...
int main(void){
    ...
    return 0;
      ...
      \begin{eqnarray}
        ...
        \frac{d^2x}{dt^2}=-\omega^2 x \label{tansindo2} 
      \end{eqnarray}

      \begin{eqnarray}
        T = \frac{2 \pi }{\omega} \label{shuki} \\
        T = 2\pi \sqrt{\frac{m}{k}} \label{shukikm}
      \end{eqnarray}
      ...
      図\ref{l0k2mv}および図\ref{l0k4mv}についても,シミュレーションの結果はおおよそ正弦関数の理論値と一致していることが読み取れる.
      このことから$l=0$のとき単振動になることが確認できた.
      ...
      \begin{tabular}{r|c|c|c}\hline
        刻み幅 & 理論値の標準偏差 & 計算値の標準偏差 & 相対誤差[\%] \\ \hline \hline 
