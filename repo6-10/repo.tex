...
\end{enumerate}
      ...
      \begin{center}
          \begin{tabular}{c|c|c|c}\hline
            条件 & $y_2 > a/c$ & $y_2 < a/c$ & $y_2 = a/c$\\ \hline
            $y_1 > b/d$  & 実験1 & 実験2 & 実験3 \\
            $y_1 < b/d$  & 実験4 & 実験5 & 実験6\\
            $y_1 = b/d$  & 実験7 & 実験8 & 実験9\\ \hline
          \end{tabular}
      \end{center}
      \end{table}

      　実験1から実験9までのパラメータ$a$,$b$,$c$,$d$を表\ref{result1-params}に示す.
      ただし,$y_1=10,y_2=10$は固定とする.
      \begin{table}[H]
      ...
      \begin{center}
          \begin{tabular}{c|c|c|c|c}\hline
            ...
            実験1-3 & 4 & 6 & 1 & 1 \\ \hline
            実験1-4 & 7 & 6 & 3 & 1 \\ \hline
            実験2-1 & 7 & 6 & 0.5 & 0.2 \\ \hline
            実験2-2 & 7 & 6 & 0.6 & 0.4 \\ \hline
            実験2-3 & 8 & 3 & 0.5 & 0.2 \\ \hline
            実験2-4 & & & & \\ \hline
            実験3 & & & & \\ \hline
            実験3 & & & & \\ \hline
            実験4 & & & & \\ \hline
      ...
      \subsubsection{実験5の結果}
      \subsubsection{実験6の結果}
      \subsubsection{実験7の結果}
      \subsubsection{実験8の結果}
      \subsubsection{実験9の結果}
